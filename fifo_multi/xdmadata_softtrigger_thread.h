#ifndef XDMADATA_SOFTTRIGGER_THREAD_H
#define XDMADATA_SOFTTRIGGER_THREAD_H
...
class xdmadata_softtrigger_thread
{
public:
    explicit xdmadata_softtrigger_thread();
	void start();
    void stop();
...
#endif // XDMADATA_SOFTTRIGGER_THREAD_H
